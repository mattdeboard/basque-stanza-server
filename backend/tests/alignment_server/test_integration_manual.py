...
from itzuli_nlp.tools.dual_analysis import analyze_both_texts
...
def test_end_to_end_pipeline():
    ...
    # Test cases
    test_cases = [
        {"text": "I don't know Basque songs", "source_lang": "en", "target_lang": "eu", "sentence_id": "test-001"},
        {"text": "Kaixo mundua", "source_lang": "eu", "target_lang": "en", "sentence_id": "test-002"},
    ]
    ...
    for i, case in enumerate(test_cases, 1):
        ...
        try:
            ...
            source_analysis, target_analysis, translated_text = analyze_both_texts(
                api_key=itzuli_key, text=case["text"], source_lang=case["source_lang"], target_lang=case["target_lang"]
            )
