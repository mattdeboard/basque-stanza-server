...
export function TranslationInput({
  ...
  if (compact && !isExpanded) {
    ...
    return (
      <div className={classNames('fixed', 'bottom-6', 'right-6', 'z-50')}>
        <button
      ...
      <>
        ...
        >
          <div className={classNames('h-full', 'flex', 'flex-col')}>
            ...
            >
              <h3 className={classNames('text-lg', 'font-medium', 'text-slate-800')}>
            ...
            {/* Form Content */}
            <div className={classNames('flex-1', 'p-4', 'overflow-y-auto')}>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className={classNames('flex', 'justify-center')}>
                    ...
                    >
                      <svg
                        className={classNames('w-5', 'h-5', 'text-slate-500')}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    maxLength={500}
                  />
                  <div className={classNames('text-xs', 'text-slate-500', 'mt-1', 'text-right')}>
            ...
            <div className={classNames('p-4', 'border-t', 'border-slate-200', 'bg-slate-50')}>
              <button
                type="submit"
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className={classNames('flex', 'items-center', 'justify-center', 'gap-4')}>
          <div className={classNames('flex', 'flex-col', 'items-center')}>
            <label
              htmlFor="source-lang"
              className={classNames('text-sm', 'font-medium', 'text-slate-600', 'mb-2')}
            >
              {t('input.source_language')}
            </label>
            <select
        ...
        <div>
          <label
            htmlFor="input-text"
            className={classNames('block', 'text-sm', 'font-medium', 'text-slate-700', 'mb-2')}
          >
            {t('input.text_label')}
          </label>
          <textarea
